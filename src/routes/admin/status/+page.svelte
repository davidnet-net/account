...
<FlexWrapper direction="column" gap="var(--token-space-4)" width="100%">
	...
	<FlexWrapper direction="row" gap="var(--token-space-6)">
		<div class="info">
			...
			{:else}
				<span style="white-space: nowrap;">Account | <a target="_blank" href={commitUrl}>{commitHash.slice(0, 7)}</a></span>
			{/if}
		</div>
	</FlexWrapper>
</FlexWrapper>
...
<h2 style="text-align: center;">Account Translation Coverage</h2>
<Space height="var(--token-space-2)" />
